    ...
    <div className="w-full flex flex-col items-center -mt-4">
      ...
      <Box sx={{width:"85%", marginTop: "2.5em", bgcolor: "rgba(255,255,255,0.15)", borderRadius: "0.25rem"}}>
        <Tabs sx={{width:"100%"}} value={value} onChange={handleChange} centered>
          <Tab style={{width:"33%",fontSize:"1.0rem" ,fontWeight: "bold", color: "white", textShadow: "1px 1px 0px #000000"}} label="Price" name="default" />
          <Tab style={{width:"33%",fontSize:"1.0rem" ,fontWeight: "bold", color: "white", textShadow: "1px 1px 0px #000000" }} label="Popular" name="popular" />
          <Tab style={{width:"33%",fontSize:"1.0rem" ,fontWeight: "bold", color: "white", textShadow: "1px 1px 0px #000000" }} label="Latest" name="latest" />
        </Tabs>
      </Box>
